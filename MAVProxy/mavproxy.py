...
def on_connect(client, userdata, flags, rc):
    __builtin__.print("Connected with result code "+str(rc))
    client.subscribe("command")

def on_message(client, userdata, msg):
	__builtin__.print(msg.topic+" "+str(msg.payload))
	process_stdin(msg.payload+"\r\n")
...
def publishToAWS(*args):
	__builtin__.print("yoyo")
